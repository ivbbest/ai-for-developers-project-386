...
- 2026-09-01 | project | Путеводитель по изучению проекта — `docs/archive/reading-guide.md` (блоки A-D: было до агента / входные материалы / что добавил агент / память; порядок чтения, минимальный путь, split-по ролям) | 2026-09-01
