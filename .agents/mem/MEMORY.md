...
## user
- 2026-08-30 | user | GitHub-репозиторий публичный, git commit/push — только пользователь | AGENTS.md «Границы действий» (устарело 2026-09-01: агент ведёт ветки/коммиты/PR, слияние в main — только пользователь)
- 2026-09-01 | user | Git-workflow: ветка `<тип>/<тема>` на каждую существенную разработку; коммит-чекпоинт на изменение; PR открывает агент; мержит только пользователь; зависимая работа — на паузе до мержа | коррекция 2026-09-01
