...
### Ревью 2026-09-03 (ветка `docs/review-recommendations`, не мержить без разбора)

- [x] Ревью всех слоёв + сверка с планом; рекомендации с обоснованиями —
      `docs/review-recommendations.md` (коммит 1f0605d); main не трогали.
      Ожидает: пуша и PR владельцем; пункты Р1–Р14 — кандидаты в следующие ветки.
