...
- [x] Остаток по документу: e2e-доводка (E3 протухший, E5 вне окна) и P3-полировка —
      закрыты раундом 2 (PR #25); email-длина осталась решением владельца (ниже)
