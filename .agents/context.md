...
- 2026-09-01 | **Правки ревью закоммичены** в ветку `docs/review-finalization` цепочкой
  из 8 атомарных коммитов (7587641…73cf762): правила → спека → анализ → план/гайды →
  индекс → память → уточнение. Push/PR — за пользователем (push агенту закрыт правилами). | 73cf762
